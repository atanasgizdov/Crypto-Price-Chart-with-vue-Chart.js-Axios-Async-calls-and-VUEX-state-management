...
<div>
  <div class="container">
    <img src="https://miro.medium.com/max/2000/0*sOHh5j3mCk_CsY1N.jpg" alt="Avatar" style="width:100%">
    <line-chart
      v-if="loaded"
      :chartdata="chartdata"
      :options="options"/>
...
export default {
  ...
  async mounted () {
    this.loaded = false
    Vue.axios
      .get('https://apiv2.bitcoinaverage.com/indices/global/ticker/BCHUSD')
      .then((response) => {
